...
import UIKit
 ...
 public protocol DateTimePickerDelegate {
   ...
   // func dateTimePickerClearBtnSelected(_ picker: DateTimePicker)
}
...
@objc public class DateTimePicker: UIView {
    ...
    public var modifiedSelectedDateString: String {
        get {
            let formatter = DateFormatter()
    ...
    private func configureView() {
        ...
        //cancelButton.addTarget(self, action: Selector("self.delegate?.dateTimePickerClearBtnSelected(self)"), for: .touchUpInside)
    ...
    private func resetDateTitle() {
        ...
        dateTitleLabel.text = modifiedSelectedDateString
